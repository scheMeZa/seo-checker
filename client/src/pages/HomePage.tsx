...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-100 dark:bg-gray-900 transition-colors py-16">
      <h1 className="text-3xl font-bold mb-10 text-primary dark:text-blue-400">SEO Checker</h1>
      <form
